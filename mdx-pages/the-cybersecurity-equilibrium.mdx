...
As one panelist noted, this can be especially true for well-resources nation state attackers:
...
- Target the most expensive, rate-limiting steps in a particular attack scenario. **[TODO: link to our attack chain analysis – currently in [this Google Doc](https://docs.google.com/document/d/1bQmq4H2Wnm03dXv5YAn_UWbIzkJ-nOQjIneTo5L1Xx0/edit?tab=t.0#heading=h.81t4wpdzg5j8) but will move.]** In particular, a large impact may occur once multiple capabilities emerge that collectively target all of the rate-limiting steps.
...
[Notes from Will AI Make Cyber Swords or Shields?](https://www.notion.so/Notes-from-Will-AI-Make-Cyber-Swords-or-Shields-12d4c916374a8088bd6aff544d93263d?pvs=21)

[Offcuts](https://www.notion.so/Offcuts-12d4c916374a80e18b2ce0ee94e7f5fe?pvs=21)
