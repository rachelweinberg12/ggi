...
export default function Page() {
  return (
      <div className="text-width-pos">
        ...
        <p className="mb-2">
          <i>This is an early, partial draft of a report by the <a href='https://www.goldengateinstitute.org/'>Golden Gate Institute for AI</a> in collaboration with <a href='https://www.linkedin.com/in/carey-nachenberg-14bbb03/'>Carey Nachenberg</a> and a panel of cybersecurity experts.</i>
        </p>
        <p className="mb-2">
          If you find this useful and would like to see more, or if you have feedback or suggestions, please reach out to <a href='mailto:steve@goldengateinstitute.org'>steve@goldengateinstitute.org</a>.
        </p>
        ...
        <p className="mb-2">
          This is unrealistic. Like any system involving multiple participants with competing interests, cybersecurity exists in a complex <b>equilibrium</b>. As a result, automation of a particular capability might not lead to a large increase in successful attacks. For instance, some attackers might be limited by the fear of retaliation, rather than an inability to scale up their operations.
        </p>
        <p className="mb-2">
          To understand how advances in AI capabilities will impact the lived experience of cyberattacks, it’s important to understand this equilibrium. On this page, we review the important mechanisms of the cybersecurity equilibrium, some asymmetries between attack and defense, and implications for how various AI capabilities might tip the balance. <b>We conclude with a simple framework for estimating the impact of AI progress on the volume and impact of cyberattacks.</b>
        </p>
        <p className="mb-2">
          <b>Read more</b>: <a href='cybersecurity-equilibrium'>The Cybersecurity Equilibrium</a>.
        </p>
        ...
        <ul>
          <li>Multiple overviews of how AI may affect cybersecurity in the coming years, targeted at different audiences such as CISOs, policymakers, and decision makers at AI labs and safety organizations.
          <li>Deeper dives into topics ranging from “how CISOs should prioritize resources” to “where tipping points in cyberattack volumes might occur” to “promising agendas for reducing risk”.
        </ul>
        <p className="mb-2">
          Getting there will require legwork, such as extending our attack chain analysis to cover more scenarios. It will also require feedback and contributions from the community. We’re currently evaluating whether and how to proceed with this project; next steps will depend on the level of interest and feedback that we receive. If you’re interested, please drop me a line at <a href='mailto:steve@goldengateinstitute.org'>steve@goldengateinstitute.org</a>.
        </p>
      </div>
  );
}
